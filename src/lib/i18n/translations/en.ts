...
export const en: Translations = {
  ...
  social: {
    ...
    myQRCode: "My QR Code",
    qrCodeDescription: "Show this code to other collectors to scan and connect with you!",
    shareProfile: "Share Profile",
    shareProfileText: "Check out my collection on Paddock!",
    linkCopied: "Profile link copied to clipboard",
    scanQRCode: "Scan QR Code",
    startingCamera: "Starting camera...",
    pointToQR: "Point the camera at another collector's QR Code",
    invalidQR: "Invalid QR Code",
    invalidQRDesc: "This QR code is not a Paddock profile",
    ...
    checkInCollection: "Check in collection",
    analyzingItem: "Analyzing item...",
    checkingCollection: "Checking in collection",
    foundInCollection: "Found!",
    hasThisItem: "has this item in collection",
    notFoundInCollection: "Not found",
    doesNotHaveItem: "doesn't have this item in collection",
